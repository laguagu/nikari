        ...
        <div className='fixed inset-0 z-10 w-screen overflow-y-auto'>
          <div className='flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0'>
            ...
            >
              ...
              <button onClick={handleClose} className='absolute top-0 right-0 m-2 text-2xl bg-red-500 text-white rounded-full h-10 w-10 flex items-center justify-center'>X</button>
                {children}
              </Dialog.Panel>
            </Transition.Child>
          </div>
